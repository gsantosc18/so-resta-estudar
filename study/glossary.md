...
→ Ver: [API Gateway](distributed-systems/07-orchestration/02-api-gateway.md)
...
→ Ver: [Message Brokers](distributed-systems/02-communication/03-message-brokers.md)
...
→ Ver: [Teorema CAP](distributed-systems/01-foundations/01-cap-theorem.md)
...
→ Ver: [Retry e Backoff](distributed-systems/04-resilience/02-retry-and-backoff.md)
...
→ Ver: [Bulkhead Pattern](distributed-systems/04-resilience/03-bulkhead-pattern.md)
...
→ Ver: [Modelos de Consistência](distributed-systems/01-foundations/02-consistency-models.md)
...
→ Ver: [Outbox Pattern](distributed-systems/03-data-patterns/03-outbox-pattern.md)
...
→ Ver: [Circuit Breaker](distributed-systems/04-resilience/01-circuit-breaker.md)

### Compensating Transaction
Transação que desfaz o efeito de uma transação anterior em um fluxo distribuído. Essencial no **Saga Pattern**.
→ Ver: [Saga Pattern](distributed-systems/03-data-patterns/02-saga-pattern.md)

### Consensus (Consenso)
Processo pelo qual nós de um sistema distribuído concordam sobre um valor ou estado. Algoritmos: Paxos, Raft, Zab.
→ Ver: [Consenso Distribuído](distributed-systems/01-foundations/03-distributed-consensus.md)
...
→ Ver: [CQRS](distributed-systems/03-data-patterns/05-cqrs.md)
...
→ Ver: [Timeout e Deadline Propagation](distributed-systems/04-resilience/04-timeout-and-deadline-propagation.md)
...
→ Ver: [Distributed Tracing](distributed-systems/06-observability/01-distributed-tracing.md)
...
→ Ver: [Event Sourcing](distributed-systems/03-data-patterns/04-event-sourcing.md)
...
→ Ver: [Event-Driven Architecture](distributed-systems/02-communication/04-event-driven-architecture.md)
...
→ Ver: [Idempotência](distributed-systems/04-resilience/05-idempotency.md)
...
→ Ver: [Horizontal vs Vertical Scaling](distributed-systems/05-scalability/01-horizontal-vs-vertical-scaling.md)
...
→ Ver: [REST e gRPC](distributed-systems/02-communication/02-rest-and-grpc.md)
...
→ Ver: [Health Checks e Readiness](distributed-systems/06-observability/04-health-checks-and-readiness.md)
...
→ Ver: [Load Balancing](distributed-systems/05-scalability/02-load-balancing.md)
...
→ Ver: [Sharding e Particionamento](distributed-systems/05-scalability/04-sharding-and-partitioning.md)
...
→ Ver: [Rate Limiting](distributed-systems/05-scalability/05-rate-limiting.md)
...
→ Ver: [Service Discovery](distributed-systems/07-orchestration/01-service-discovery.md)
...
→ Ver: [Service Mesh](distributed-systems/07-orchestration/03-service-mesh.md)
